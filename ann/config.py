...
class Config(object):  
  ...
  AWS_SNS_JOB_ARCHIVE_TOPIC = "arn:aws:sns:us-east-1:127134666975:zyx_archive_results"

  AWS_SQS_REQUEST = "zyx_job_requests"
  AWS_SQS_RRESULT = "zyx_job_results"
  AWS_SQS_ARCHIVE = "zyx_archive_results"
